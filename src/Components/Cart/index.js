    ...
    if(isCartOpen){
        return(
            ...
            <div className="fixed z-50 top-0 right-0 flex flex-col items-center gap-8 w-full h-full p-6 bg-white text-xl md:w-[30rem]">
                ...
                <button className="flex items-center justify-center p-4 font-bold w-3/4 bg-red-500 hover:bg-red-300"
            ...
            <div className="fixed top-0 w-full h-full opacity-60 bg-black"
            onClick={()=> dispatch(closeCart())}
            >
            </div>
            </>
